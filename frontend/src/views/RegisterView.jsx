...
export default function RegisterView() {
    ...
    return (
        <div style={{ maxWidth: '400px', margin: '3rem auto', padding: '2rem', border: '1px solid #ddd', borderRadius: '8px', fontFamily: 'sans-serif' }}>
            ...
            {/* FULLY EMBEDDED REGISTRATION INPUT FIELDS */}
            <form onSubmit={handleRegisterSubmit}>
                ...
                <button 
                    type="submit" 
                    disabled={loading} 
                    style={{ width: '100%', padding: '0.75rem', background: '#28a745', color: '#fff', border: 'none', borderRadius: '4px', fontWeight: 'bold', cursor: 'pointer' }}
                >
            ...
            <div style={{ display: 'flex', alignItems: 'center', margin: '2rem 0' }}>
                ...
                <span style={{ padding: '0 1rem', color: '#777', fontSize: '0.85rem' }}>OR REGISTER WITH</span>
                <div style={{ flex: 1, height: '1px', background: '#ddd' }}></div>
            </div>
            ...
            <div style={{ borderTop: '1px solid #eee', marginTop: '2rem', paddingTop: '1.5rem', textAlign: 'center' }}>
                <span style={{ fontSize: '0.9rem', color: '#666', display: 'block', marginBottom: '0.75rem' }}>Already have an account?</span>
                <Link to="/login" style={{ display: 'block', width: '100%', padding: '0.65rem', boxSizing: 'border-box', background: '#fff', color: '#007bff', border: '1px solid #007bff', borderRadius: '4px', fontWeight: 'bold', textDecoration: 'none', textAlign: 'center', fontSize: '0.9rem' }}>Sign In</Link>
            </div>
        </div>
    );
}
